...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideTestData(userRepository: UserRepository, customerRepository: CustomerRepository, transactionRepository: TransactionRepository): TestDataLoader {
        return TestDataLoader(userRepository, customerRepository, transactionRepository)
    }
}