...
sealed class CardMenuItem(override val title: String, @DrawableRes override val iconRes: Int) : MenuItem {
    class Edit : CardMenuItem("Edit Card", R.drawable.ic_edit_card)
    class Delete : CardMenuItem("Delete Card", R.drawable.ic_delete_card)
    class Freeze : CardMenuItem("Freeze Card", R.drawable.ic_freeze)
