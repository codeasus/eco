...
object BankCardDefaults {
    ...
    object NormalCardColors : ThemedColors {
        ...
        override val colorTextLighter = Color(255, 255, 255, 255)
    ...
    object UnknownCardColors : ThemedColors {
        override val colorBackground = Color(44, 68, 93, 141)
        override val colorTextDarker = Color(108, 123, 141, 255)
        override val colorTextLighter = Color(255, 255, 255, 255)
        override val colorBackgroundShape = android.graphics.Color.argb(120, 255, 255, 255)
    }
}